...
RedDogCleandates <- CleanRedDog[CleanRedDog$DateTime >= "2022-05-05 00:00:00" & CleanRedDog$DateTime <= end_date, ]


BombahCleandates <- BombahCleandates[-which(is.na(BombahCleandates$Latitude)),]
SWYCleandates <- SWYCleandates[-which(is.na(SWYCleandates$Latitude)),]#dont run, no zeroes
AndyCleandates <- AndyCleandates[-which(is.na(AndyCleandates$Latitude)),]#dont run, no zeroes
TekkaCleandates <- TekkaCleandates[-which(is.na(TekkaCleandates$Latitude)),]#dont run, no zeroes
...
png("Figures/Supplementary/MCPs2.png", width = 20, height = 13, res= 300, units = "in")
